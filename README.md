...
Спасибо, что прочитали инструкцию, надеюсь на обратную связь. Проект является пробой пера для технологий TypeScript, Jest/Enzyme (пол дня на изучение и реализацию), не судите слишком строго 😊
